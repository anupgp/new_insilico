...
#ifndef INCLUDE_NEWINSILICO_RANDOM_HPP
#define INCLUDE_NEWINSILICO_RANDOM_HPP

#include <random>

//using namespace newinsilico;
using namespace std;
...
namespace newinsilico {
  ...
  public:
    template<class T>
    static T rand(T min, T max); // function rand
    template<class T>
    static T rand(T max);  // function rand
  }; // class random
} // namespace newinsilico
